...
def model_encoder(input_imgs, input_messages):
    ...
    x = Conv2D(64, (3, 3), activation='relu', padding='same', strides=1)(input_imgs)
    ...
    encoded_images = Conv2D(64, (3, 3), activation='relu', padding='same', strides=1)(x_batch)
    encoded_images = Conv2D(C, (1, 1), padding='same', strides=1)(encoded_images)
